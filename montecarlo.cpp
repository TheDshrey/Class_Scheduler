...
int MonteCarlo (map<int, map<int, int> >& classTable, vector<vector<int> >& schedule, vector<vector<int> >& schedule2, vector<int> crnTeacher, int cost,int row_max,int col_max) {
    ...
    int max_unincrease = crnTeacher.size()+1;//testing
